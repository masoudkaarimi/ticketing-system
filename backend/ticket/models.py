...
class Category(MPTTModel):
    name = models.CharField(max_length=255, verbose_name=_("Name"), null=False, blank=False, unique=True,
...
class Ticket(MPTTModel):
    category = models.ForeignKey(Category, related_name="ticket_category", on_delete=models.SET_NULL,
                                 verbose_name=_("Category"), blank=True,
                                 null=True)
    user = models.ForeignKey(User, related_name="ticket_user", verbose_name=_("Author"), on_delete=models.CASCADE,
                             blank=False, null=False)
    status = models.CharField(max_length=15, choices=TICKET_STATUS, default="PENDING", verbose_name=_("Status"),
                              blank=True, null=True)
    title = models.CharField(max_length=255, verbose_name=_("Title"), null=False, blank=False, unique=False,
...
class Media(models.Model):
    ticket = models.ForeignKey(Ticket, related_name="media_ticket", verbose_name=_("Belongs To"), blank=True,
