...
const TicketInfo = ({fetcher}) => {
    ...
    const ticketMutateAction = useMutation({
        ...
        mutationFn: (variables) => ticketActionApi(variables.id, variables.type, variables.value),
            ...
            <Card variant="outlined">
                <CardContent>
                    ...
                    <TicketActions
                        ...
                        onChange={(value) =>
                            ticketMutateAction.mutate({id: data?.id, type: "status", value: value})
                        }
                    />
                    <TicketActions
                        ...
                        onChange={(value) => {
                            ticketMutateAction.mutate({id: data?.id, type: "priority", value: value})
                        }}
                    />
                </CardContent>
            </Card>
