import {
    Box, Button, Card, CardContent, CircularProgress, Container, TextField, Typography
} from "@mui/material";
import { useState } from "react";
import { Person } from "@mui/icons-material";
import { useDispatch, useSelector } from "react-redux";
import { useNavigate } from "react-router-dom";
import { login, register } from "../features/actions/authActions";
      ...
      <Box className="center-block">
        <Card variant="outlined">
          <CardContent component="form" onSubmit={handleOnSubmit}>
            ...
            <Box
                sx={{
                    display: "flex", gap: {xs: 0, md: 3}, flexWrap: {xs: "wrap", md: "nowrap"}
                }}
            >
              <TextField
                  type="text"
